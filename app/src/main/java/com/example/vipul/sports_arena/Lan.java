...
public class Lan extends Fragment{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        lanRecyclerView = (RecyclerView) rootView.findViewById(R.id.lanRecyclerView);

        lanRecyclerView.setHasFixedSize(true);
        lanRecyclerView.setLayoutManager(new LinearLayoutManager(rootView.getContext()));
            ...
            try {
                ...
                while (counterr < jsonArray.length()) {
                    ...
                    if (counterr == jsonArray.length() - 1) {
                        lanRecyclerView.setAdapter(arenaAdapter);
